package com.ohgiraffers.fworks.auth.config;

import com.ohgiraffers.fworks.auth.filter.CustomAuthenticationFilter;
import com.ohgiraffers.fworks.auth.filter.JwtAuthenticationFilter;
import com.ohgiraffers.fworks.auth.handler.JwtAccessDeniedHandler;
import com.ohgiraffers.fworks.auth.handler.JwtAuthenticationEntryPoint;
import com.ohgiraffers.fworks.auth.handler.LoginFailureHandler;
import com.ohgiraffers.fworks.auth.handler.LoginSuccessHandler;
        ...
        return http.
                ...
                .authorizeHttpRequests(auth -> {
                    ...
                    * 이 때 OPTIONS 메소드로 서버에 사전 요청을 보내 확인한다. */
                    ...
                    auth.requestMatchers(HttpMethod.GET, "/imgs/**").permitAll();
                    auth.requestMatchers(HttpMethod.POST, "/api/v1/employees/regist").permitAll();
//                    auth.requestMatchers(HttpMethod.GET, "/api/v1/employees/test").permitAll();
                    auth.requestMatchers(HttpMethod.GET, "/api/v1/employees").permitAll();
                    auth.requestMatchers(HttpMethod.POST, "/api/v1/employees/login").permitAll();
//                    auth.requestMatchers("/api/v1/products/*/reviews/**").authenticated();
//                    auth.requestMatchers("/api/v1/employees/regist").hasRole("ADMIN");
