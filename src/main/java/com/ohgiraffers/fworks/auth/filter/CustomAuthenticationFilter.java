package com.ohgiraffers.fworks.auth.filter;
...
public class CustomAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public CustomAuthenticationFilter() {
        ...
        super(new AntPathRequestMatcher("/api/v1/employees/login", "POST"));
    }
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException, IOException, ServletException {
        ...
        String empId = bodyMap.get("empId");
        String empPw = bodyMap.get("empPw");

        if (empId == null || empPw == null) {
            throw new AuthenticationServiceException("empId and empPw must be provided");
        }

        log.info("CustomAuthenticationFilter empId : {}", empId);
        log.info("CustomAuthenticationFilter empPw : {}", empPw);
